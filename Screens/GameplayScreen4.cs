...
namespace ChickenFarm
{
    public class GameplayScreen4 : GameScreen
    {
        ...
        private SnakeSprite[] lrSnakes;
        private SnakeSprite2[] udSnakes;
        ...
        public override void Activate()
        {
            ...
            lrSnakes = new SnakeSprite[]
            {
                new SnakeSprite((new Vector2(250, 400)), SnakeDirection.Right),
                new SnakeSprite((new Vector2(550, 350)), SnakeDirection.Left)
            };

            udSnakes = new SnakeSprite2[]
            {
                new SnakeSprite2((new Vector2(300, 200)), Snake2Direction.Down),
                new SnakeSprite2((new Vector2(200, 300)), Snake2Direction.Up)
            };

            squareSnakes = new SnakeSprite3[]
            {
                new SnakeSprite3((new Vector2(300, 150)), SnakeDirection_3.Down),
                new SnakeSprite3((new Vector2(450, 200)), SnakeDirection_3.Right)
            };
            ...
            foreach(var snake in lrSnakes)
            {
                snake.LoadContent(_content);
            }

            foreach (var snake in udSnakes)
            {
                snake.LoadContent(_content);
            }
