...
{
    public enum GoofySnakeDirection
    {
        Right = 0,
        Left = 1,
    }
    public class GoofySnake
    {
        ...
        public GoofySnake(Vector2 position, SnakeDirection direction)
        {
        ...
        public void Draw(GameTime gametime, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(texture, position, source, Color.Black, 0.75f, new Vector2(0, 0), 1.5f, spriteEffects, 0);
        }
    }
}
